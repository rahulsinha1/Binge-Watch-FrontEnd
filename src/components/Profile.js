...
export default function Profile() {
  ...
  function addAddress(params) {
    ...
    axios
      .post(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/addAddress/" +
  ...
  function addPhone(params) {
    ...
    axios
      .post(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/addPhone/" +
          localStorage.getItem("username"),
        state
      )
      .then(function (response) {
  ...
  function getPhone() {
    ...
    axios
      .post(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/find/username/" +
          localStorage.getItem("username"),
        state
      )
      .then(function (response) {
  ...
  function update(params) {
    ...
    axios
      .post(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/update/" +
          localStorage.getItem("username"),
        state
      )
    ...
    // axios
    //   .post("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/update", state)
    //   .then(function (response) {
    //     console.log(response);
    // localStorage.setItem("username", response.data.username);
    // localStorage.setItem("email", response.data.email);
  ...
  function removePhone(params) {
    ...
    axios
      .post(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/removePhone/" +
          localStorage.getItem("username"),
        params
      )
      .then(function (response) {
  ...
  // useEffect(() => {
  //   axios
  //     .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/currentUser")
  //     .then(function (response) {
  //       console.log(this);
  //       if (response["date"] !== "") {
  //         setState({
  ...
  //   // fetch("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/currentUser", {
  //   //   method: "GET",
  //   //   credentials: "include",
  //   // })
