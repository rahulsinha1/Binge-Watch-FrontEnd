...
export default function UserList() {
  ...
  function deleteUser(param) {
    axios
      .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080//api/user/delete/" + param)
      .then(function (response) {
        console.log(response);
        alert("user deleated");
  ...
  function updateRoleUser(param) {
    axios
      .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080//api/user/updateRole/" + param + "/" + "USER")
      .then(function (response) {
        console.log(response);
        window.location.href = "/userList/";
      });
  ...
  function updateRoleCritic(param) {
    axios
      .get(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080//api/user/updateRole/" + param + "/" + "CRITIC"
      )
      .then(function (response) {
        console.log(response);
        window.location.href = "/userList/";
  ...
  function updateRoleAdmin(param) {
    axios
      .get(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080//api/user/updateRole/" + param + "/" + "ADMIN"
      )
      .then(function (response) {
        console.log(response);
        window.location.href = "/userList/";
