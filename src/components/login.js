...
export default function LoginPage() {
  ...
  function authorize(params) {
    ...
    try {
      axios
      .post("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/login", state)
  ...
  window.location.href = "/movie";
      ...
      // });
      ;
    // fetch("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080/api/user/login", {
    //   method: "POST",
    ...
    //   });
    // axios
    // .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8080//api/user/find/username/"+loginUser.username)
    // .then(function (response) {
