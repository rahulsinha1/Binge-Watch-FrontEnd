...
export default function MovieFun(name) {
  ...
  function search(params) {
    axios
      .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8083/api/movies/find/?name=" + params["name"])
      .then(function (response) {
        // console.log(response);
  ...
  function followUser(userName) {
    axios
      .get(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8083/api/user/follow/" +
          localStorage.getItem("username") +
          "/" +
          userName
      )
  ...
  function getStreamer() {
    axios
      .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8083//api/streamers/find/" + name["name"])
      .then(function (response) {
        console.log(response);
  ...
  function getListUser() {
    axios
      .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8083//api/likedBy/" + name["name"])
      .then(function (response) {
  ...
  function deleteStreamer(params) {
    axios
      .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8083//api/streamers/delete/" + params)
      .then(function (response) {
        // console.log(response.data);
        window.location.href = "/movieDetail/" + name["name"];
      })
  ...
  function review(feedback) {
    ...
    axios
      .post(
        "http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8083/api/user/addmovieReview/" +
          localStorage.getItem("username") +
          "/" +
          name["name"],
        {},
  ...
  function showReview(name){
      axios
      .get("http://ec2-18-220-141-147.us-east-2.compute.amazonaws.com:8083/api/movieReview/find/"+ name["name"])
      .then(function(response){
        console.log(response);
